...
- **Navegação, contexto e formulários:** 234 verificações aprovadas: seis perfis/composições; autorização de rotas, paciente correto, retorno, CPF/endereço e preservação cruzada de TUSS/Pix.
