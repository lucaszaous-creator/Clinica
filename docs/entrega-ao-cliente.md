...
| ~~**73 — O REGISTRO do atendimento**~~ ✅ | Consultório + shell | A **consulta de enfermagem em cinco etapas** (COFEN 358/2009: histórico, diagnóstico, planejamento, prescrição de enfermagem e avaliação), com catálogo de 13 diagnósticos e 19 cuidados; a sessão médica com **história da doença atual, exame físico e hipótese diagnóstica com CID**; tudo chegando à via em PAPEL, à exportação, ao art. 18 II e à linha do tempo | A cliente reprovou a parcela 72 com *"está muito CRU"*, e acertou: aquela entregou PORTAS e não encostou no **ato de atender** — os dois registros eram **um campo de texto**, e o da enfermagem era, além de pobre, **fora da COFEN 358/2009**. `docs/registro-do-atendimento.md` |
| ~~**74 — O atendimento como SESSÃO**~~ ✅ | Consultório + Recepção | A barra de atendimento com **duração ao vivo** e **Finalizar atendimento**, que salva a sessão e avisa o balcão (selo "Encerrado às 14h32" no cartão da fila); as **sete seções do prontuário num rail vertical**, com prescrições, documentos e anexos DENTRO do paciente; o **crachá clínico** com foto, idade, convênio, desde quando, alergias e últimas hipóteses | A cliente mandou o print do iClinic: *"estamos muito atrás, anos luz atrás"*. O atendimento era um FORMULÁRIO, prescrever exigia SAIR do paciente, e o carimbo do início existia desde a parcela 38 **sem nenhum leitor no app de quem atende**. `docs/registro-do-atendimento.md` §8-14 |
| ~~**75 — A anamnese do paciente e o plano**~~ ✅ | Consultório | Seção **Anamnese** (antecedentes pessoais e familiares, hábitos, interrogatório, história obstétrica), **versionada** e com a idade da última revisão na tela; **plano terapêutico** na sessão, que sai no relatório de evolução | A cliente disse que o módulo continuava cru para atendimento. Medido: o buraco não era "mais campos na sessão" — a anamnese do PACIENTE não tinha onde morar, e o plano era espremido entre conduta e orientações. `docs/registro-do-atendimento.md` §15-20 |
