...
![Nova agenda diária — Recepção](implementado/02-grade-profissionais.png)

## Semana do profissional

![Nova agenda semanal](implementado/03-grade-semana.png)

## Atendimentos do dia — Recepção

![Recepção — fluxo do dia preservado](implementado/01-recepcao-dia.png)

## Meu dia — Clínico

![Clínico — fluxo do dia preservado](implementado/09-clinico-dia.png)
