...
try {
    ...
    & $efTablet migrations script 20260910120000_AssinaturaRemotaGuardadaAntesDaConferencia 20260916173014_AtendimentoClinicoTablet --idempotent --project src/Clinica.Infrastructure --startup-project src/Clinica.Infrastructure -o (Join-Path $saidaTablet 'migracao-tablet.sql')
