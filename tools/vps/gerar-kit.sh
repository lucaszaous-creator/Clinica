...
#
# Uso:  ./gerar-kit.sh SENHA-DO-PFX maquina1 [maquina2 ...]
# Ex.:  ./gerar-kit.sh 'Lacre2026' recepcao-01 recepcao-02 consultorio-01
#
...
if [ -z "$SENHA" ] || [ "$#" -eq 0 ]; then
  echo "Uso: ./gerar-kit.sh SENHA-DO-PFX nome-maquina-1 [nome-maquina-2 ...]"
  exit 1
fi
if [ ! -f ca.key ]; then
