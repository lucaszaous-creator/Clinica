...
public sealed partial class PacienteWorkspaceViewModel : ObservableObject
{
    ...
    /// trabalho sem leitor.
    /// </summary>
    public bool PodeFinalizarSessao => _horario is
        { Status: StatusAgendamento.Agendado, InicioAtendimentoEm: not null };
    public bool PodeConcluirComAcesso => PodeMoverFila && SessaoUsuario.Atual.Pode(Permissao.LancarAtendimento);
    public string RotuloFinalizarSessao => _horario?.FimAtendimentoEm is not null
        ? "Concluir atendimento pendente" : "Finalizar atendimento";
