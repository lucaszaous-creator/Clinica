...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddClinica(this IServiceCollection services, string connectionString)
    {
        ...
        services.AddScoped<PoliticaMateriaisService>();
        ...
        services.AddScoped<ResultadoExameService>();
        services.AddScoped<AnexoPacienteService>();
        services.AddScoped<ImportacaoAnexosSmartClinicService>();
        ...
        services.AddScoped<ImportacaoSmartClinicService>();
