...
namespace Clinica.Infrastructure.Migrations
{
    ...
    [Migration("20260923190924_EdicaoEnfermagemExclusiva")]
    partial class EdicaoEnfermagemExclusiva
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Agendamento", b =>
                {
                    ...
                    b.Property<string>("ChaveImportacao")
                        .HasMaxLength(160)
                    ...
                    b.Property<DateTime?>("EnfermagemConferidaEm")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int?>("EnfermagemConferidaPorUsuarioId")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("HouveAtendimentoEnfermagem")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.AnexoPaciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CaminhoRemoto")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ArquivoAnexoPaciente", b =>
                {
                    b.Property<int>("AnexoPacienteId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("AnexoPacienteId");

                    b.ToTable("ArquivosAnexoPaciente", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ArquivoResultadoExame", b =>
                {
                    ...
                    b.ToTable("ArquivosResultadoExame", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Atendimento", b =>
                {
                    ...
                    b.Property<string>("EstornadoPor")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.CampoPersonalizadoProntuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CamposPersonalizadosProntuario");
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ChecagemCuidado", b =>
                {
                    ...
                    b.Property<int>("CuidadoEnfermagemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CuidadoEnfermagemId", "Data");

                    b.ToTable("ChecagensCuidado");
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ColetaRemotaTermo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EvidenciaResposta")
                        .HasMaxLength(600)
                        .HasColumnType("character varying(600)");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ConferenciaConsumoProcedimento", b =>
                {
                    ...
                    b.Property<string>("MateriaisJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.DocumentoClinico", b =>
                {
                    ...
                    b.Property<string>("CorpoFormatado")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ObservacoesFormatadas")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.EdicaoEnfermagemTablet", b =>
                {
                    b.Property<int>("AgendamentoId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EdicoesEnfermagemTablet", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Evolucao", b =>
                {
                    ...
                    b.Property<DateOnly?>("RetornoSugeridoEm")
                        .HasColumnType("date");

                    b.Property<string>("RetornoSugeridoNota")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.EvolucaoEnfermagem", b =>
                {
                    ...
                    b.Property<string>("AcessoCalibre")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("AcessoLocal")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.Property<DateOnly?>("AcessoPuncionadoEm")
                        .HasColumnType("date");
                    ...
                    b.Property<string>("FaseAtendimento")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ItemDocumento", b =>
                {
                    ...
                    b.Property<string>("DescricaoFormatada")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DetalheFormatado")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ItemEstoque", b =>
                {
                    ...
                    b.Property<bool>("ExigirLote")
                        .HasColumnType("boolean");

                    b.Property<bool>("ExigirValidade")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal>("FatorCompra")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(14, 3)
                        .HasColumnType("numeric(14,3)")
                        .HasDefaultValue(1m);
                    ...
                    b.Property<string>("Grupo")
                        ...
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasDefaultValue("MaterialAssistencial");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.LancamentoFinanceiro", b =>
                {
                    ...
                    b.Property<Guid?>("GrupoObrigacao")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("OrigemDesdobramentoId")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("ValorOriginalObrigacao")
                        .HasPrecision(14, 2)
                        .HasColumnType("numeric(14,2)");
                    ...
                    b.HasIndex("GrupoObrigacao");

                    b.HasIndex("IdBancario");

                    b.HasIndex("OrigemDesdobramentoId");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ModeloDocumento", b =>
                {
                    ...
                    b.Property<string>("ConfiguracaoInfusao")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ModeloEvolucaoEnfermagem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("NomeChave")
                        .IsUnique();

                    b.ToTable("ModelosEvolucaoEnfermagem");
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.MovimentoEstoque", b =>
                {
                    ...
                    b.Property<decimal?>("CustoInformado")
                        .HasPrecision(14, 4)
                    ...
                    b.Property<string>("DestinoConsumo")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<string>("DocumentoEntrada")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
                    ...
                    b.Property<decimal?>("QuantidadeInformada")
                        .HasPrecision(14, 3)
                        .HasColumnType("numeric(14,3)");
                    ...
                    b.Property<string>("UnidadeInformada")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.OperacaoClinicaTablet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OperacoesClinicasTablet", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.PrescricaoInterna", b =>
                {
                    ...
                    b.Property<string>("OrientacaoExterna")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<bool>("OrigemEnfermagem")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Profissional", b =>
                {
                    ...
                    b.Property<bool>("AgendaProtegida")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ResultadoExame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ArquivoTamanho")
                        .HasColumnType("integer");

                    b.Property<string>("ArquivoTipoConteudo")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
                    ...
                    b.Property<int?>("PedidoDocumentoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.SessaoTablet", b =>
                {
                    ...
                    b.Property<long?>("AtividadeClinicaEm")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ArquivoAnexoPaciente", b =>
                {
                    b.HasOne("Clinica.Domain.Entities.AnexoPaciente", "Anexo")
                        .WithOne("Arquivo")
                        .HasForeignKey("Clinica.Domain.Entities.ArquivoAnexoPaciente", "AnexoPacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ArquivoResultadoExame", b =>
                {
                    b.HasOne("Clinica.Domain.Entities.ResultadoExame", "Resultado")
                        .WithOne("Arquivo")
                        .HasForeignKey("Clinica.Domain.Entities.ArquivoResultadoExame", "ResultadoExameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ChecagemCuidado", b =>
                {
                    b.HasOne("Clinica.Domain.Entities.CuidadoEnfermagem", "Cuidado")
                        .WithMany("Checagens")
                        .HasForeignKey("CuidadoEnfermagemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Clinica.Domain.Entities.ChecagemCuidado", "RetificaChecagem")
                        .WithMany()
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.EdicaoEnfermagemTablet", b =>
                {
                    ...
                    b.HasOne("Clinica.Domain.Entities.SessaoTablet", null)
                        .WithMany()
                        .HasForeignKey("SessaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.LancamentoFinanceiro", b =>
                {
                    ...
                    b.HasOne("Clinica.Domain.Entities.LancamentoFinanceiro", "OrigemDesdobramento")
                        .WithMany()
                        .HasForeignKey("OrigemDesdobramentoId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Clinica.Domain.Entities.PacotePaciente", "PacotePaciente")
                        .WithMany()
                        .HasForeignKey("PacotePacienteId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("OrigemDesdobramento");
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.ResultadoExame", b =>
                {
                    ...
                    b.HasOne("Clinica.Domain.Entities.DocumentoClinico", "PedidoDocumento")
                        .WithMany()
                        .HasForeignKey("PedidoDocumentoId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Evolucao", b =>
                {
                    ...
                    b.Navigation("CamposPersonalizados");
