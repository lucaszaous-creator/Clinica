...
/// <summary>
/// A busca de paciente do sistema inteiro, num lugar só.
///
/// Antes cada tela reescrevia a mesma coisa (Pacientes, Novo atendimento, Agendamento e a
/// pesquisa global do topo), e cada cópia tinha um limite diferente — 50, 6 e duas sem limite
/// nenhum. Além do resultado inconsistente, as cópias sem limite traziam a base inteira pela
/// rede a cada tecla digitada.
///
/// Este seletor resolve os três problemas de uma vez:
/// <list type="bullet">
...
/// </list>
/// A tela de <b>lista</b> (Pacientes) usa o mesmo seletor com <c>limite: null</c> — ela precisa
/// mostrar todo mundo — e com <see cref="Refinar"/> para aplicar filtro de convênio e ordenação.
/// </summary>
public sealed partial class SeletorPacienteViewModel : ObservableObject
{
    ...
    [ObservableProperty] private bool _travado;
    ...
    /// <summary>Disparado depois de cada busca concluída (a tela recalcula o que deriva da lista).</summary>
