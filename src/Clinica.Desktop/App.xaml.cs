...
public partial class App : System.Windows.Application
{
    ...
    /// <summary>
    /// Se alguma guia passou do prazo de decisão (pendente há mais que o intervalo configurado), abre a
    /// janela BLOQUEANTE de "rodar as pendências": a secretária precisa dar baixa ou justificar (não
    /// conformidade) antes de seguir. Nunca derruba o app.
    /// </summary>
